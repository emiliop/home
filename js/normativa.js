...
function showList() {
    ...
    for (var i = (page * pageSize); i < maxElements; i++) {
        var tempElement = "<div class=\"event-container\"><div class=\"col-md-12\">";
        tempElement += "<div class=\"row element-law-container\">";
        tempElement += "<div class=\"col-md-9 element-event-text\"><div class=\"col-md-12 event-date\">" + normativityDocs[i].date + "</div><div class=\"element-event-body mb-2\">" + normativityDocs[i].text + "</div>";
        tempElement += "</div> <div class=\"col-md-3 event-date\"><a type=\"button\" class=\"btn btn-outline-primary transparency-button-document\" target=\"_blank\" href=\"" + normativityDocs[i].link + "\">Descargar documento</a></div></div></div><hr class=\"gray-semilight my-4\"></div>";
    ...
    jQuery("#news-container2").html(elementNormativityToAdd);
    jQuery('html,body').scrollTop(1);
}

function showListArticles() {
    var elementObservatoyToAdd = "";
    elementObservatoyToAdd = "<div class=\"row\"><div class=\"col-md-12 title-section-container\"><h4>NORMATIVA RECIENTE</h4></div> <div class=\"col-md-12 recent-news-container\"> <div class=\"row\">"
    for (var i = 0; i < 4; i++) {
        console.log(i);
        elementObservatoyToAdd += "<a class=\"col-md-12 title-section-container\" href=\"./articulo.html?id=" + i + "\"><div class=\"row\"><div class=\"col-md-12\">" + normativityDocs[i].date + "</div><div class=\"col-md-12\">" + normativityDocs[i].text + "</div></div></a>";
    }
    elementObservatoyToAdd += "</div></div>";

    jQuery("#recent-container").html(elementObservatoyToAdd);
}
